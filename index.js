...
const RESTART_WAIT = 5000;

const Dolphin = function (opts) {
...
Dolphin.prototype.docker = function (args) {
    ...
    return new Promise(function (resolve, reject) {
        var docker = child.spawn('docker', args, {
            env: _this.env
        });
        var result = '';
        var err = '';
...
Dolphin.prototype.cmd = function cmd(args, cb) {
    ...
    return new Promise((resolve, reject) => {
        ...
        const childProcess = child.spawn('docker', args, {
            env: this.env
        });
